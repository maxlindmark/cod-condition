...
plot_dat <- bind_rows(m_juv_est, m_adu_est, m_25_28_est, m_rec_est, m_full_st)
...
ggsave("figures/supp/condition/sensitivity_coefficients.png", width = 6.5, height = 6.5, dpi = 600)
