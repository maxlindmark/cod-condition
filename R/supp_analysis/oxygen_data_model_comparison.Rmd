...
#knitr::include_graphics("data/OCEANOGRAPHY/oxygen_data_download.png")
```

```{r read in ices data}
ices <- read.delim("data/OCEANOGRAPHY/Ocean_d1f9ae38-9a6d-44d4-aee1-8b3ab7b582d7/8e079dde-5c00-4f61-a79c-2f8f1de63c56.txt")
