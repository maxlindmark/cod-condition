---
title: "Condition model: test large cod"
...
ggsave("figures/supp/effect_sizes_large_cod_model.png", width = 5, height = 7.5, dpi = 600)
```
...
ggsave("figures/supp/condition_index_large_cod_model.png", width = 6.5, height = 6.5, dpi = 600)
```
