...
# Intro
Fit CPUE (density) model with environmental predictors and use that to calculate weighted mean dissolved oxygen, temperature and depth of Baltic cod
...
png(file = "figures/supp/cpue_qq.png", units = "in", width = 6.5, height = 6.5, res = 300)
...
ggsave("figures/supp/cpue_spatial_resid.png", width = 6.5, height = 6.5, dpi = 600)
```
...
# Plot predicted CPUE and random effects
ggplot(swe_coast_proj) +
...
ggsave("figures/supp/cpue_est_map.png", width = 6.5, height = 6.5, dpi = 600)
...
ggsave("figures/supp/cpue_epsilon_st_map.png", width = 6.5, height = 6.5, dpi = 600)
...
ggsave("figures/supp/cpue_omega_s_map.png", width = 6.5, height = 6.5, dpi = 600)
```
...
ggsave("figures/cpue.png", width = 6.5, height = 6.5, dpi = 600)
```
...
wm_depth <- preds_cod$data %>%
  ...
  summarise(#depth_wm = weighted.mean(depth, exp(est)), # This is the mean
            "Density-weighted median" = hutils::weighted_quantile(v = depth, w = exp(est), p = c(0.5)),
            "Density-weighted quantile (0.1)" = hutils::weighted_quantile(v = depth, w = exp(est), p = c(0.1)),
            "Density-weighted quantile (0.9)" = hutils::weighted_quantile(v = depth, w = exp(est), p = c(0.9))) %>% 
  pivot_longer(cols = c("Density-weighted median", "Density-weighted quantile (0.1)", "Density-weighted quantile (0.9)"),
...
wm_oxy <- preds_cod$data %>%
  ...
  summarise(#oxy_wm = weighted.mean(oxy, exp(est)), # This is the mean
            "Density-weighted median" = hutils::weighted_quantile(v = oxy, w = exp(est), p = c(0.5)),
            "Density-weighted quantile (0.1)" = hutils::weighted_quantile(v = oxy, w = exp(est), p = c(0.1)),
            "Density-weighted quantile (0.9)" = hutils::weighted_quantile(v = oxy, w = exp(est), p = c(0.9))) %>% 
  pivot_longer(cols = c("Density-weighted median", "Density-weighted quantile (0.1)", "Density-weighted quantile (0.9)"),
...
wm_temp <- preds_cod$data %>%
  ...
  summarise(#temp_wm = weighted.mean(temp, exp(est)), # This is the mean
            "Density-weighted median" = hutils::weighted_quantile(v = temp, w = exp(est), p = c(0.5)),
            "Density-weighted quantile (0.1)" = hutils::weighted_quantile(v = temp, w = exp(est), p = c(0.1)),
            "Density-weighted quantile (0.9)" = hutils::weighted_quantile(v = temp, w = exp(est), p = c(0.9))) %>% 
  pivot_longer(cols = c("Density-weighted median", "Density-weighted quantile (0.1)", "Density-weighted quantile (0.9)"),
...
ggsave("figures/cpue_weighted_dep_pxy.png", width = 6.5, height = 8.5, dpi = 600)

temp_plot + plot_w_temp +
  plot_annotation(tag_levels = 'A') + plot_layout(ncol = 2) + 

  ggsave("figures/supp/cpue_weighted_temp.png", width = 6.5, height = 8.5, dpi = 600)
```
