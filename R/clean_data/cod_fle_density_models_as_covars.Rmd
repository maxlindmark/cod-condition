...
### Cod
# SD 24
preds_cod24_sim <- predict(mcod, newdata = filter(pred_grid, sub_div == 24), nsim = 100)

# SD 25
preds_cod25_sim <- predict(mcod, newdata = filter(pred_grid, sub_div == 25), nsim = 100)

# SD 26
preds_cod26_sim <- predict(mcod, newdata = filter(pred_grid, sub_div == 26), nsim = 100)

# SD 27
preds_cod27_sim <- predict(mcod, newdata = filter(pred_grid, sub_div == 27), nsim = 100)

# SD 28
preds_cod28_sim <- predict(mcod, newdata = filter(pred_grid, sub_div == 28), nsim = 100)
...
### Flounder
# SD 24
preds_fle24_sim <- predict(mfle, newdata = filter(pred_grid, sub_div == 24), nsim = 100)

# SD 25
preds_fle25_sim <- predict(mfle, newdata = filter(pred_grid, sub_div == 25), nsim = 100)

# SD 26
preds_fle26_sim <- predict(mfle, newdata = filter(pred_grid, sub_div == 26), nsim = 100)

# SD 27
preds_fle27_sim <- predict(mfle, newdata = filter(pred_grid, sub_div == 27), nsim = 100)

# SD 28
preds_fle28_sim <- predict(mfle, newdata = filter(pred_grid, sub_div == 28), nsim = 100)
...
write.csv(div_index_sim, "cod_fle_index.csv")
```
