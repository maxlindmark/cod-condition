...
samps <- sdmTMBextra::predict_mle_mcmc(mcod_1, mcmc_iter = 201, mcmc_warmup = 200)

mcmc_res_cod <- residuals(mcod_1, type = "mle-mcmc", mcmc_samples = samps)

qqnorm(mcmc_res_cod);qqline(mcmc_res_cod)
```
...
samps <- sdmTMBextra::predict_mle_mcmc(mfle_1, mcmc_iter = 201, mcmc_warmup = 200)

mcmc_res_fle <- residuals(mfle_1, type = "mle-mcmc", mcmc_samples = samps)
