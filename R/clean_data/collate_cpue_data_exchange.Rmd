...
# kg of fish per km^2 by dividing with 0.45 and by multipliying with the haulduration in hours
...
hlcodhaul <- hlcodL3 %>%
  ...
  mutate(haul_cpue_kg = sum(CPUEst_kg),
         ...
         abund = haul_cpue * (HaulDur / 60),
         haul_kg = haul_cpue_kg * (HaulDur / 60),
         density = haul_kg/0.45,
