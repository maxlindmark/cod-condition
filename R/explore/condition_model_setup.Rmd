...
$$
\operatorname{log}(w_{s,t})\sim\operatorname{Student-t}(\mu_{s,t},\nu,\phi)\\
...
$$
\alpha_t \sim \operatorname{Normal}(\alpha_{t-1}, \sigma^2_\alpha).
$$
...
\boldsymbol\delta_{t>1} = \phi_{\delta}\boldsymbol\delta_{t-1} + \sqrt{1-\phi_{\delta}^2}\boldsymbol\epsilon_t, \boldsymbol\epsilon_t \sim \operatorname{MVNormal}(\boldsymbol0, \boldsymbol\Sigma_\epsilon).
$$
